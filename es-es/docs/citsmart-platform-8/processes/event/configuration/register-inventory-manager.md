...
[Registrar categoria de ocurrencia](/es-es/citsmart-7/processes/event/configuration/register-occurence-category.html)
...
[Registrar conexión Inventory](/es-es/citsmart-7/processes/event/configuration/set-inventory-connection.html)
