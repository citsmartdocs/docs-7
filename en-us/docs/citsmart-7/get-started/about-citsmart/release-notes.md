...
In version 7.0.1.3 the parameter “452 - Continue in the Ticket screen after saving?” was created. This parameter, when enabled, checks the user's permission to execute a ticket and allows the screen to remain..
...
-   Preconditions:
    ...
    1.  The client will be upgrading from version 7 to version 7.0.0.5;
...
| Problem | Description                                                                                                                                                                                                          |
|----------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2573     | Known error in version 7.0.0.0 when answering to a satisfaction survey by Experience Center Widget. Version 7.0.0.3 provides a definitive solution to the error while registring a satisfaction survey.     |
| 2122     | Webservice failed to create service request. Version 7.0.0.3 provides definitive solution to the failure presented when attempting to register a service request via webservice.                      |
| 2917     | Failed to upload attachments by the service request functionality. Version 7.0.0.3 provides a solution for uploading attachments through the service request functionality.                  |
...
| Problem | Description                                                                                                                                                                                                                                                                 |
|----------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2309     | Intermittent failure and of greater incidence in clustered environments in the method that returns timezone to register date and time. Version 7.0.0.2 provides definitive solution to the error that occurs in classes that use timezone for registration. |
...
|Improvements|Knowledge Management|In version 7.0.0.0 CITSmart allows the evaluation and publication of written comments about a knowledge. For further information, see [Comments Review][8]|
|Improvements|Knowledge Management|We innovate the way of access to the knowledge base for users who don't have login to the CITSmart tool. In version 7.0.0.0 knowledge with permission of visualization can be accessed by the community in general, just have the link of access. For further information, see Configure external access to the [Knowledge Portal][9]|
...
|New|Smart analytics|From the version 7.0.0.0, we have provided some quantitative reports of the main processes contained in CITSmart through our new BI platform. For further information, see [Business Intelligence][17]|
...
[1]:/en-us/citsmart-7/processes/tickets/use/register-ticket-related.html
[2]:/en-us/citsmart-7/processes/tickets/use/create-and-view-sub-request.html
[3]:/en-us/citsmart-7/processes/tickets/configuration/notification-delegated-email-ticket.html
[4]:/en-us/citsmart-7/processes/portfolio-and-catalog/configuration/send-email-reclassified-ticket.html
[5]:/en-us/citsmart-7/processes/change/overview.html
[6]:/en-us/citsmart-7/processes/problem/overview.html
[7]:/en-us/citsmart-7/processes/release/overview.html
[8]:/en-us/citsmart-7/processes/knowledge/use/review-reviews.html
[9]:/en-us/citsmart-7/processes/knowledge/configuration/configure-external-access-knowledge-portal.html
[10]:/en-us/citsmart-7/processes/configuration/overview.html
[11]:/en-us/citsmart-7/processes/tickets/use/create-escalation-rule.html
[12]:/en-us/citsmart-7/processes/tickets/use/approve-a-ticket.html
[13]:/en-us/citsmart-7/processes/tickets/use/desktop-of-service-desk.html
[14]:/en-us/citsmart-7/processes/tickets/use/register-ticket-occurrences.html
[15]:/en-us/citsmart-7/additional-features/project-management/simple-agile-management/simple-agile-management.html
[16]:/en-us/citsmart-7/processes/knowledge/use/create-experience-center.html
[17]:/en-us/citsmart-7/additional-features/smart-analytics/use-bi-solution.html
[18]:/en-us/citsmart-7/platform-administration/logs-and-auditing/system-audit.html
[19]:/en-us/citsmart-7/platform-administration/security/implement-password-security-rules.html
[20]:/en-us/citsmart-7/additional-features/mobile-and-field-service/apps/citsmart-field-service-manual.html
[21]:/en-us/citsmart-7/additional-features/mobile-and-field-service/apps/citsmart-app.html
